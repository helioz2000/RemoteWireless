...
{
    SpiWriteReg(CC1101_FSCTRL1,  0x08);   // Freq synthesizer control
    SpiWriteReg(CC1101_FSCTRL0,  0x00);   // Freq synthesizer control
    SpiWriteReg(CC1101_FREQ2,    0x10);   // Freq ctrl word HIGH
    SpiWriteReg(CC1101_FREQ1,    0xA7);   // Freq ctrl word MID
    SpiWriteReg(CC1101_FREQ0,    0x62);   // Freq ctrl word LOW
    SpiWriteReg(CC1101_MDMCFG4,  0x5B);   // Modem config
    SpiWriteReg(CC1101_MDMCFG3,  0xF8);   // Modem config
    SpiWriteReg(CC1101_MDMCFG2,  0x03);   // Modem config
    SpiWriteReg(CC1101_MDMCFG1,  0x22);   // Modem config
    SpiWriteReg(CC1101_MDMCFG0,  0xF8);   // Modem config
    SpiWriteReg(CC1101_CHANNR,   0x00);   // Channel number
    SpiWriteReg(CC1101_DEVIATN,  0x47);   // Modem deviation setting
    SpiWriteReg(CC1101_FREND1,   0xB6);   // Front End RX config
    SpiWriteReg(CC1101_FREND0,   0x10);   // Front End TX config
    SpiWriteReg(CC1101_MCSM0 ,   0x18);   // Main Radio Control State Machine config 
    SpiWriteReg(CC1101_FOCCFG,   0x1D);   // Frequency offset compensation config
    SpiWriteReg(CC1101_BSCFG,    0x1C);   // Bit synchronisation config
    SpiWriteReg(CC1101_AGCCTRL2, 0xC7);   // AGC control
	  SpiWriteReg(CC1101_AGCCTRL1, 0x00);   // AGC control
    SpiWriteReg(CC1101_AGCCTRL0, 0xB2);   // AGC control
    ...
    SpiWriteReg(CC1101_FSCAL0,   0x11);   // Frequency synthesizer calibration
    SpiWriteReg(CC1101_FSTEST,   0x59);   // Frequency synthesizer calibration control
    SpiWriteReg(CC1101_TEST2,    0x81);   // test settings
    SpiWriteReg(CC1101_TEST1,    0x35);   // test settings
    SpiWriteReg(CC1101_TEST0,    0x09);   // test settings
